...
/// case.
// Directory flushing lives in `crate::durability` so the platform quirks are
// stated once; see that module for why Windows cannot flush a directory.
use crate::durability::fsync_dir;
